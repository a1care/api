...
const buildPatientAuthResponse = (patient: any, token: string) => ({
  token,
  userType: "patient" as const,
  appType: "user" as const,
  homeScreen: "UserHome" as const,
  profileCompleted: Boolean(patient?.isRegistered),
  user: {
    ...
    isRegistered: Boolean(patient.isRegistered)
  }
});
