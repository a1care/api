...
import { getPatientDetailsById, sentOtpForPatient, updateProfile, verifyOtpForPatient, updatePatientFcmToken, requestPatientDeletion, refreshTokenForPatient } from './patient.controller.js'
