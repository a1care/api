...
const doctorValidation = z.object({
    ...
    consultationFee: z.number().min(0, "Fee cannot be negative").max(10000, "Fee cannot exceed ₹10,000").optional(),
    homeConsultationFee: z.number().min(0, "Fee cannot be negative").max(10000, "Fee cannot exceed ₹10,000").optional(),
    onlineConsultationFee: z.number().min(0, "Fee cannot be negative").max(10000, "Fee cannot exceed ₹10,000").optional(),
