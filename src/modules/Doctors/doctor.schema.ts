...
const doctorValidation = z.object({
    ...
    homeConsultationFee: z.coerce.number().min(0, "Fee cannot be negative").optional(),
    onlineConsultationFee: z.coerce.number().min(0, "Fee cannot be negative").optional(),
    about: z.string().optional(),
    workingHours: z.string().optional(),
    serviceRadius: z.coerce.number().min(0, "Radius cannot be negative").optional(),
    roleId: z.string(),
    ...
    fulfillmentMode: z.enum(["HOME_VISIT", "HOSPITAL_VISIT", "VIRTUAL"]).optional(),
