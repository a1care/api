...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <div className={`w-64 bg-white h-screen fixed left-0 top-0 shadow-card z-30 flex flex-col transition-transform duration-300 ease-in-out md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                }`}>
                {/* Logo Section */}
