                ...
                <div className="bg-white py-8 px-4 shadow-xl shadow-gray-100 sm:rounded-xl sm:px-10 border border-gray-100">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-3">
                            <div className="flex items-center justify-center px-4 py-2 border border-gray-200 rounded-lg bg-gray-50 text-sm text-gray-600">
                                <span className="font-medium mr-2">Email:</span> admin@a1care.com
                            </div>
                            <div className="flex items-center justify-center px-4 py-2 border border-gray-200 rounded-lg bg-gray-50 text-sm text-gray-600">
                                <span className="font-medium mr-2">Pass:</span> Admin@123
                            </div>
                        </div>
                    </div>
                </div>
