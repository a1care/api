...
import { checkOtpStatus, createDoctor, getDoctorById, getStaffByRoleId, getStaffDetials, registerStaff, sendOtpForStaff, updateFcmToken, verifyOtp, requestDeletionStaff } from './doctor.controller.js'
...
router.post("/auth/request-deletion", protect, requestDeletionStaff)
